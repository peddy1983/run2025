...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log('📅 查詢日期:', today.toLocaleDateString('zh-TW'));
    ...
    // 組合通知訊息
    let message = `🌅 早安！今天的跑步活動\n`;
    message += `📅 ${today.toLocaleDateString('zh-TW', { month: 'long', day: 'numeric', weekday: 'short' })}\n`;
    message += `━━━━━━━━━━━━━━━━\n\n`;
